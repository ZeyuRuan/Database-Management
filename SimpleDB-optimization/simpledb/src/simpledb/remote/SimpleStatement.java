...
public class SimpleStatement extends StatementAdapter {
   ...
   public ResultSet executeQuery(String qry, int type) throws SQLException {
      try {
         RemoteResultSet rrs = rstmt.executeQuery(qry, type);
   ...
   public ResultSet executeQuery(String qry) throws SQLException {
      try {
         RemoteResultSet rrs = rstmt.executeQuery(qry, 2);
         return new SimpleResultSet(rrs);
      }
      catch(Exception e) {
         throw new SQLException(e);
