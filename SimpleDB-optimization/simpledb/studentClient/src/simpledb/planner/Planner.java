...
public class Planner {
    ...
    */
   public Plan createQueryPlan(String qry, Transaction tx, int joinType) {
      Parser parser = new Parser(qry);
      QueryData data = parser.query();
      Plan queryPlan = qplanner.createPlan(data, tx, joinType);
      // Print number of blocks accessed
      System.out.println("***********************************");
      System.out.println("BLOCKS ACCESSED: " + queryPlan.blocksAccessed());
      System.out.println("***********************************");
      return queryPlan;
   }
